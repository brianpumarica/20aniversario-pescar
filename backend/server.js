...
const port = process.env.PORT || 8082; // Puerto en el que se ejecutará la aplicación 8082

// Iniciar el servidor
app.listen(port, () => {
  console.log(`La aplicación está escuchando en el puerto: ${port} ${FRONTEND_URL}`);
});
